...
rearTypeData <- function(sampRates = .1, censusSizes = 3000, relSizePBTgroups = 1, tagRates = .8, obsTagRates = .8, physTagRates = 0,
				    true_clipped = .5, true_noclip_H = .2, true_wild = .3){
